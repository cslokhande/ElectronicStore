...
public class UserController {
    ...
    public ResponseEntity<UserDto> updateUser(@Valid @RequestBody UserDto userDto, @PathVariable Long userId) {
        ...
        logger.info("Completion request for update a user for {userId}" +userId);
    ...
    public ResponseEntity<UserDto> getUser(@PathVariable Long userId) {
        ...
        logger.info("Completion request for get a user for {userId}"+userId);
    ...
    public ResponseEntity<ApiResponse> deleteUser(@PathVariable Long userId) {
        ...
        logger.info("Completion request for delete user by userId"+userId);
    ...
    public ResponseEntity<UserDto> uploadPostImage(@RequestParam("image") MultipartFile image,
        ...
        logger.info("Completion step for uploading image by using postId"+userId);
