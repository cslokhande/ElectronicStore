...
public class CategoryController {
    ...
    public ResponseEntity<CategoryDto> updateCategory(@Valid @RequestBody CategoryDto categoryDto, @PathVariable Long categoryId) {
        ...
        logger.info("Completion request for update category for {categoryId}"+categoryId);
    ...
    public ResponseEntity<CategoryDto> getCategory(@PathVariable Long categoryId) {
        ...
        logger.info("Completion request for get category for {categoryId}" + categoryId);
    ...
    public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Long categoryId) {
        ...
        logger.info("Completion request for delete category for {categoryId}"+ categoryId);
